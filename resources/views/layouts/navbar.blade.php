      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu fsz-sm">
          <li>
            ...
            @elseif (Auth::user()->status == 'donor')
              <a href="{{route('donor.edit')}}" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700">
                <i class="ti-user mR-10"></i>
                <span>Profile</span>
              </a>
          ...
          <li>
            <a href="" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700">
              <i class="ti-layout-grid2 mR-10"></i>
              <span>Dashboard</span>
            </a>
          </li>
          {{-- <li>
          ...
          <li>
            <a class="d-b td-n pY-5 bgcH-grey-100 c-grey-700" href="{{ route('logout') }}"
               onclick="event.preventDefault();
                ...
                <i class="ti-power-off mR-10"></i> {{ __('Logout') }}
            </a>
